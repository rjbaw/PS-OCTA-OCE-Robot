...
# Logs
make logs         # summarize the newest incident and create a support bundle
...
Make targets:
  ...
  logs   - Summarize the latest incident and create a support bundle
...
#+ATTR_LATEX: :options frame=lines, linenos
#+begin_src bash
make logs                    # newest operational incident

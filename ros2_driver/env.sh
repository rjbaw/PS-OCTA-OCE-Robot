...
export RTI_CONFIG_FILE=${HOME}/PS-OCTA-OCE-Labview-autofocus-Ren/ros2_driver/connext/dds_config.xml
...
export RTI_LICENSE_FILE=${HOME}/PS-OCTA-OCE-Labview-autofocus-Ren/ros2_driver/connext/uni_license.dat
